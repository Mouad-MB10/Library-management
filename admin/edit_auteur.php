...
$requete="SELECT * FROM auteurs WHERE auteur_id=".$_GET['ai'];
...
<div class="row">
 ...
 <div class="col-md-4">
     ...
     <div class="form-group">
          ...
          <div class="form-group">
            <label >Auteur Name:</label>
            <input type="text" class="form-control" name="auteur_name" value="<?php echo $auteur_name; ?>">
          </div>
          <div class="form-group">
...
<?php
	if(isset($_POST['Update'])){
		...
		$requete= "UPDATE  auteurs set name = '$_POST[auteur_name]' where auteur_id = $_GET[ai]";
        if($pdo->exec($requete)){
            ?>
            <script>
