...
$requete="SELECT * FROM books WHERE book_id=".$_GET['bi'];
...
<div class="row">
 ...
 <div class="col-md-4">
     ...
     <div class="form-group">
            ...
            <input type="text" class="form-control" name="book_no" value="<?php echo $book_no; ?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="auteur_id" value="<?php echo $auteur_id; ?>">
          </div>
          <div class="form-group">
            <label >Category ID:</label>
            <input type="text" class="form-control" name="cat_id"  value="<?php echo $cat_id; ?>">
          </div>
...
<?php
	if(isset($_POST['Update'])){
		...
		$requete= "UPDATE  books set book_name = '$_POST[book_name]',auteur_id=$_POST[auteur_id],cat_id=$_POST[cat_id] where book_id = $_GET[bi]";
        if($pdo->exec($requete)){
            ?>
            <script>
