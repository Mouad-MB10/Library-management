...
$requete="SELECT * FROM books NATURAL JOIN auteurs NATURAL JOIN categories";
    ...
    <table class="table table-bordered table-hover">
      <thead>
        ...
        foreach ($data as $row) {
         ...
         $book_Auteur=$row['name'];
         $book_categorie=$row['cat_name'];
         $book_number=$row['book_no'];
   
         $book_img=$row['images'];
         ?>
             <tr>
             <td><?php echo  $book_name ; ?></td>
             <td><?php echo  $book_Auteur ;?></td>
             <td><?php echo  $book_categorie ;?></td>
             <td><img src="images/<?php echo  $book_img ;?>" alt="" width="60px" height="60px"></td>
             <td><?php echo  $book_number ;?></td>
            
             <td>
                 <button class="btn"><a href="edit_book.php?bi=<?php echo $row['book_id']; ?>">Edit</a></button>
                 <button class="btn"><a href="delete_book.php?bi=<?php echo $row['book_id']; ?>">Delete</a></button>
            </td>
            </tr>
         <?php }
     ?>
