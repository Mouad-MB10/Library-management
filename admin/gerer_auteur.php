 ...
 <li class="nav-item">
     ...
     <li class="nav-item dropdown">
         ...
         <ul class="dropdown-menu">
                ...
                <li><a href="gerer_acteur.php">gérer les Auteurs</a></li>
         </ul>
     </li>
    ...
    <table class="table table-bordered table-hover">
      <thead>
        ...
        foreach ($data as $row) {
         ...
         $Auteur_name=$row['name'];
         ?>
             <tr>
             <td><?php echo  $auteur_id;?></td>
             <td><?php echo   $Auteur_name ;?></td>
             <td>
                 <button class="btn"><a href="edit_auteur.php?ai=<?php echo $row['auteur_id']; ?>">Edit</a></button>
                 <button class="btn"><a href="delete_auteur.php?ai=<?php echo $row['auteur_id']; ?>">Delete</a></button>
            </td>
            </tr>
         <?php }
     ?>
