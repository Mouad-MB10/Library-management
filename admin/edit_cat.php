...
$requete="SELECT * FROM categories WHERE cat_id=".$_GET['ci'];
...
<div class="container-fluid">
 <ul class="nav navbar-nav navbar-center">
     ...
     <li class="nav-item dropdown">
         <a class="nav-link" href="issuesbook.php" >Issue Book</a>
     </li>
 </ul>
</div>
</nav>
...
<?php
	if(isset($_POST['Update'])){
		...
		$requete= "UPDATE  categories set cat_name = '$_POST[cat_name]' where cat_id = $_GET[ci]";
        if($pdo->exec($requete)){
            ?>
            <script>
