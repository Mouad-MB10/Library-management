...
$requete="SELECT books.book_name,books.book_no,auteurs.name FROM books LEFT JOIN auteurs ON books.auteur_id=auteurs.auteur_id";
    ...
    <form action="">
        ...
        <?php
           foreach ($data as $row) {
            ...
            $book_stocks=$row['book_no'];
            $auteur_name=$row['name'];
            ?>
                <tr>
                <td><?php echo  $book_name;?></td>
                <td><?php echo  $book_stocks ;?></td>
